<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="Reasonmaster.aspx.cs" Inherits="Reasonmaster" %>
     ...
     <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Add Reason</h4>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="">
                                        Short Code
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="txtshrt" ControlToValidate="txtname" ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                    </label>
                                    <div>
                                        <asp:TextBox runat="server" ID="txtshrt" ValidationGroup="AddSt" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-xs-12 table-responsive">
                                <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Name" HeaderText="Reason" />
