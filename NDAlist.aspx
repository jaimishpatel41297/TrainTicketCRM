<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="NDAlist.aspx.cs" Inherits="NDAlist" %>
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">NDA List</h4>
            </div>
                        ...
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="OnDutyTime" HeaderText="OnDuty Time" />
                                    <asp:BoundField DataField="OffDutyTime" HeaderText="OffDuty Time" />
