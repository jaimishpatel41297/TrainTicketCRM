<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="AddDivision.aspx.cs" Inherits="AddDivision" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12 col-xs-12">
                                <div class="form-group">
                                    <label for="">
                                        Division Name
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddSt" ControlToValidate="txtname" ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
